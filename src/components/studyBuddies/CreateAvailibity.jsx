        ...
        <div>
           <form>
                <div className="form-group">
                    ...
                    <input type="date" className="form-control" id="date" name="date" onChange={handleChange} placeholder="Enter date" />
                    <label htmlFor="topic">Topic</label>
                    <input type="text" className="form-control" id="topic" name="topic" onChange={handleChange} placeholder="Enter topic" />
